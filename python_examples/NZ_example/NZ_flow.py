...
pe.Parameters.set_file(os.path.join(os.path.dirname(__file__),
                                    "NewZealand_noInt_parameters.json"))
...
sim_params = {"simulation_start_time": 0, "simulation_end_time": 45,
              "initial_infected_number": 0, "initial_infect_cell": True,
              "simulation_seed": 42}

file_params = {"output_file": "output_NZ_noInt.csv",
...
plt.savefig(os.path.join(os.path.dirname(__file__),
            "simulation_outputs/SIR_noInt.png"))
...
p = Plotter(os.path.join(os.path.dirname(__file__),
            "simulation_outputs/output_NZ_noInt.csv"),
...
p.barchart(os.path.join(os.path.dirname(__file__),
           ...
           "simulation_outputs/NZ_weeky_cases_noInt.csv"),
