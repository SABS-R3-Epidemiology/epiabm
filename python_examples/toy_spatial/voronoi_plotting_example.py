...
def generate_animation(
    ...
    if use_pillow:
        ...
        ani.save((save_path + str(gif_name)), writer=writer,
                 dpi=200)
    else:
        file_names = []
        for i, t in enumerate(times):
...
animation_path = ("voronoi_outputs/")
anim = generate_animation(df, vor, gif_name, name="InfectionStatus.InfectMild",
