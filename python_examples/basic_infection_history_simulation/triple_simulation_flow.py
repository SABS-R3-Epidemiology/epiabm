...
sim.configure(
    ...
    [pe.sweep.TripleSweep(), pe.sweep.QueueSweep(),
...
filename = os.path.join(os.path.dirname(__file__), "triple_simulation_outputs",
                        "output.csv")
...
plt.savefig(
            os.path.join(os.path.dirname(__file__),
                         "triple_simulation_outputs",
                         "triple_simulation_flow_SIR_plot.png")
)
