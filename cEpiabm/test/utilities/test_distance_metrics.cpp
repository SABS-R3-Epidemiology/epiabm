...
TEST_CASE("utilities/distance_metrics: test distance metric init", "[DistanceMetrics]")
{   // tests the Dist function returns the same as the DistEuclid
    DistanceMetrics subject = DistanceMetrics();
}

TEST_CASE("utilities/distance_metrics: test distance metric", "[DistanceMetrics]")
{   // tests the Dist function returns the same as the DistEuclid
...
TEST_CASE("utilities/distance_metrics: test Euclidean distance metric", "[DistanceMetrics]")
{   
    auto loc = std::make_pair(1.0, 1.0);
...
TEST_CASE("utilities/distance_metrics: test Covidsim distance metric", "[DistanceMetrics]")
