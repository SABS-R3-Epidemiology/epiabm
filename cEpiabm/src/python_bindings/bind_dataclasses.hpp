...
void bind_dataclasses(py::module &m)
{
    ...
    py::class_<Person, PersonPtr>(m, "Person")
        ...
        .def("add_place", [](PersonPtr p, PopulationPtr population, CellPtr cell, size_t place_index, size_t group)
            { p->addPlace(*population, cell.get(), place_index, group); })
        .def("remove_place", [](PersonPtr p, PopulationPtr population, CellPtr cell, size_t place_index, size_t group)
            { p->removePlace(*population, cell.get(), place_index, group); })
        .def("remove_place_all_groups", [](PersonPtr p, PopulationPtr population, CellPtr cell, size_t place_index)
